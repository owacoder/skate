...
namespace skate {
    ...
    template<typename... ContainerParams>
    struct is_array<CArray<ContainerParams...>> : public std::true_type {};
    ...
    struct abstract_front<CArray<ContainerParams...>> {
        abstract_front(const CArray<ContainerParams...> &c, const typename abstract_list_element_type<CArray<ContainerParams...>>::type *&front) { front = &c.GetHead(); }
        abstract_front(CArray<ContainerParams...> &c, typename abstract_list_element_type<CArray<ContainerParams...>>::type *&front) { front = &c.GetHead(); }
    };

    template<typename... ContainerParams>
    struct abstract_back<CArray<ContainerParams...>> {
        abstract_back(const CArray<ContainerParams...> &c, const typename abstract_list_element_type<CArray<ContainerParams...>>::type *&back) { back = &c.GetTail(); }
        abstract_back(CArray<ContainerParams...> &c, typename abstract_list_element_type<CArray<ContainerParams...>>::type *&back) { back = &c.GetTail(); }
    };
    ...
    public:
        ...
        abstract_back_insert_iterator &operator=(R &&element) { 
            c->SetSize(c->GetSize(), 1 + (c->GetSize() / 2));
            c->InsertAt(c->GetSize(), std::forward<R>(element)); 
            return *this; 
        }
    ...
    struct abstract_front<CList<ContainerParams...>> {
        abstract_front(const CList<ContainerParams...> &c, const typename abstract_list_element_type<CList<ContainerParams...>>::type *&front) { front = &c.GetHead(); }
        abstract_front(CList<ContainerParams...> &c, typename abstract_list_element_type<CList<ContainerParams...>>::type *&front) { front = &c.GetHead(); }
    };

    template<typename... ContainerParams>
    struct abstract_back<CList<ContainerParams...>> {
        abstract_back(const CList<ContainerParams...> &c, const typename abstract_list_element_type<CList<ContainerParams...>>::type *&back) { back = &c.GetTail(); }
        abstract_back(CList<ContainerParams...> &c, typename abstract_list_element_type<CList<ContainerParams...>>::type *&back) { back = &c.GetTail(); }
    };

    template<typename... ContainerParams>
    struct abstract_element<CList<ContainerParams...>> {
        abstract_element(const CList<ContainerParams...> &c, size_t n, const typename abstract_list_element_type<CList<ContainerParams...>>::type *&el) { auto it = begin(c); std::advance(it, n); el = &*it; }
        abstract_element(CList<ContainerParams...> &c, size_t n, typename abstract_list_element_type<CList<ContainerParams...>>::type *&el) { auto it = begin(c); std::advance(it, n); el = &*it; }
    };
